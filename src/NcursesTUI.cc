...
//_____________________________________________________________________________
void
NcursesTUI::DrawChannelList( void )
{
  GotoXY( 1, 5+NCmd );
...
//_____________________________________________________________________________
void
NcursesTUI::DrawCommandList( void )
{
  int color;
  for( int i=0, n=m_command_list.size(); i<n; ++i ){
    GotoXY( 1, i+4 );
